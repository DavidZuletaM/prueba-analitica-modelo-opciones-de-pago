...
n_pipeline = Pipeline(
    steps=[
        ...
        (
            "feature_selection",
            SelectFromModel(RandomForestClassifier(n_estimators=100, random_state=0, n_jobs=3)),
        ),
        (
            "RFClassifier",
...
param_grid = {
    'RFClassifier__n_estimators':np.arange(50,100,150),
    'RFClassifier__min_samples_leaf': [1,2],
    'RFClassifier__min_samples_split':[2,5],
    'RFClassifier__max_depth': [5,10,15]    
}
